...
#include <testrobot_description_plugins/UnderwaterObjectROSPlugin.hh>
...
//***********  this function is for flow visualisation only *************************************
...
//*******************VIP function 1******************************
// returns an object _res that contains a stack of links with 
// specified hydrodynamic properties
     ...
     testrobot_msg_stack::GetModelProperties::Response& _res)
{
       ...
       it != models.end(); ++it)
  {
	    ...
	    testrobot_msg_stack::UnderwaterObjectModel model;
	    double param;
